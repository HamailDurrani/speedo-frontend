...
async function drawRouteOnMap(routeName) {
  try {
    const res = await fetch('https://speedo-backend.onrender.com/live-routes');
...
async function getAISuggestion() {
  ...
  try {
const res = await fetch('https://speedo-backend.onrender.com/api/ai', {
      method: 'POST',
      headers: {
...
async function loadSchedule() {
  ...
  try {
const res = await fetch('https://speedo-backend.onrender.com/schedule');
    const data = await res.json();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      try {
const res = await fetch('https://speedo-backend.onrender.com/feedback', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
